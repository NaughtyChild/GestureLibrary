...
public class LockPatternUtil {
    ...
    /**
     * check the touch point is or not in the circle
     *
     * @param sx     the x position of circle's center point
     * @param sy     the y position of circle's center point
     * @param r      the radius of circle
     * @param x      the x position of event
     * @param y      the y position of event
